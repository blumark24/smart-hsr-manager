...
function validateShortSummaryAr(value, { confidence = null } = {}) {
  ...
  // Keep safety/quality validation structural and semantic. The actionable recommendation
  // is already mandatory in recommendedActionAr, so the short visual summary does not
  // need to contain one of a brittle fixed list of Arabic action words.
