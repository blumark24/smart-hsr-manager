'use strict';
// Builds geo-core.bundle.js from platform/browser/geo-core-entry.js.
// Same dependency-free, deterministic local-require bundler already used
// by scripts/build-preview-assignment-bundle.js — no esbuild/webpack step,
// no source maps, output is plain readable JS behind a tiny require shim.
const fs = require('node:fs'); const path = require('node:path'); const crypto = require('node:crypto');
const root = path.resolve(__dirname, '..'), entry = path.join(root, 'platform/browser/geo-core-entry.js'), output = path.join(root, 'geo-core.bundle.js');
